...
# Set up scales for the experiments
...
for d in feature_scales:
    for n in sample_scales:
        ...
        # Create the SVC's
        clf = LinearSVC(dual=True, max_iter = 2147483647)
...
plt.title('Scalability of SciKit SVM Primal: Training Time vs. Number of Samples')
plt.legend()
plt.xscale('log')
plt.yscale('log')
